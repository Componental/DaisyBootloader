...
HARDENING='-DDUBBY_STAY_IN_DFU_IF_INCOMPLETE=1 -DDUBBY_ENCODER_DFU=1'
make -C libDaisy -j8
mkdir -p dubby-dist
...
cp bootloader/build/dsy_bootloader_v6_4-extdfu-2000ms.bin dubby-dist/dubby_bootloader_v6_4-extdfu-2000ms-uid96-hardening-v2.bin
cp bootloader/build/dsy_bootloader_v6_4-extdfu-2000ms.elf dubby-dist/dubby_bootloader_v6_4-extdfu-2000ms-uid96-hardening-v2.elf
make -C bootloader clean
